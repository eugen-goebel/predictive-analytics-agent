...
class TestPermutationImportance:
    ...
    def _evaluate_with(self, X, y, task_type, tmp_path, **kwargs):
        ...
        from agents.model_trainer import TrainingResult, ModelScore
        training_result = TrainingResult(
            best_model_name=model.__class__.__name__,
            best_score=0.5, task_type=task_type,
            model_scores=[ModelScore(name=model.__class__.__name__, score=0.5, cv_std=0.0, training_time=0.0)],
